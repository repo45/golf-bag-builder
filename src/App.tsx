...
const App: React.FC = () => {
  ...
  const handleAddToBag = (club: Club) => {
    ...
    if (!selectedClubs.some(c => c.id === club.id)) {
      ...
      const clubWithImage = {
        ...club,
        image_path: clubModel ? `src/assets/club_images/${clubModel.image}.jpg` : "driver_images/placeholder.jpg"
      };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <ClubDetailModal
        ...
        selectedClubs={selectedClubs}
        imageSrc={selectedClubModel ? `/src/assets//${selectedClubModel.image}.jpg` : "https://via.placeholder.com/300x200?text=Golf+Club"}
        onClose={() => {
